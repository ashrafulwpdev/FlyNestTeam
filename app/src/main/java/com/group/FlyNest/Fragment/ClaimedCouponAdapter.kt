...
class ClaimedCouponAdapter(
    private var offers: List<CouponOffer>
) : RecyclerView.Adapter<ClaimedCouponAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_coupon_claimed, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        // Button is disabled in XML, no click listener needed
    }
