...
class ExpiredCouponAdapter(
    private var offers: List<CouponOffer>
) : RecyclerView.Adapter<ExpiredCouponAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_coupon_expired, parent, false)
